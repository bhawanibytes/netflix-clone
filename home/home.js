// Consts
const apikey = "3faf49e00b344c02903fe6f6075c1219";
...
const apiPaths = {
    ...
    _fetchTrending: `${apiEndpoint}/trending/all/day?api_key=${apikey}&language=en-US`,
    get fetchTrending() {
        return this._fetchTrending;
    },
    set fetchTrending(value) {
        this._fetchTrending = value;
    },
    searchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyCJVw64_zEZW3KCQaIupW-f88u5_Ft1ouQ`
}
...
function searchMovieTrailer(movieName, iframId) {
    ...
    fetch(apiPaths.searchOnYoutube(movieName))
        ...
        .then(res => {
            ...
            const div = document.createElement('div');
            div.innerHTML = `<iframe width="245px" height="150px" src="https://www.youtube.com/embed/${bestResult.id.videoId}?autoplay=1&controls=1"></iframe>`
